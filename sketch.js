...
function setup() {
  ...
  trex = createSprite(displayWidth/5,displayHeight-220,20,50);
  
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.7;
  
  ground = createSprite(displayWidth/2,displayHeight-210,displayWidth*2,20);
  ...
  restart = createSprite(displayWidth/2,displayHeight/3+70);
...
function draw() {
  ...
  background(255);
  textSize(20);
  text("Score: "+ score,displayWidth/5-200,displayHeight/5 -100);
